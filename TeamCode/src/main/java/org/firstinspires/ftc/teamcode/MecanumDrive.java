...
public final class MecanumDrive {
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, Constants.Drive.FL);
        leftBack = hardwareMap.get(DcMotorEx.class, Constants.Drive.RL);
        rightBack = hardwareMap.get(DcMotorEx.class, Constants.Drive.RR);
        rightFront = hardwareMap.get(DcMotorEx.class, Constants.Drive.FR);
