...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1656.78944; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 474.27172; // x position of the perpendicular encoder (in tick units)
    }
